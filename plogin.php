...
<center><a href="pregister.php" class="badge badge-success mt-4">Click Here, If You Have not Created Your Username & Password</a></center>
    </div>
HTML;
}
...
function validateLogin($username,$password){
	...
	return $user;	
				...
				if($user = validateLogin($_POST['username'],$_POST['password'])){
					...
					echo '<meta http-equiv="refresh" content="0;url=pbook.php" />';
			}
				else{
