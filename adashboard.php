...
<div class="card col-lg-3" style="width: 18rem;">
  ...
  <div class="card-body">
    <h5 class="card-title">Remove Patient Info</h5>
    <p class="card-text">Click the button below to Remove patient information</p>
    <a href="amodify.php" class="btn btn-primary">Click Here</a>
  </div>
</div>
<div class="card col-lg-3" style="width: 18rem;">
  ...
  <div class="card-body">
    ...
    <p class="card-text">click the button below to edit Appointments</p>
    <a href="eappoint.php" class="btn btn-primary">Click Here</a>
  </div>
</div>
<div class="card col-lg-3" style="width: 18rem;">
  ...
  <div class="card-body">
    ...
    <p class="card-text">Click the button below to Add Doctors</p>
    <a href="docadd.php" class="btn btn-primary">Click Here</a>
  </div>
</div>
 <div class="card col-lg-3" style="width: 18rem;">
  <img src="./images/pic14.png" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">Remove/Modify Doctors Info </h5>
    <p class="card-text">Click the button below to update doctor info</p>
    <a href="docmodify.php" class="btn btn-primary">Click Here</a>
  </div>
   </div>
  </div>
</div>
